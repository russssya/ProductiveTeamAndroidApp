...
public class ListAdapterTaskTomorrowDone extends RecyclerView.Adapter<ListAdapterTaskTomorrowDone.ViewHolder>{

    final LayoutInflater inflater;
    final List<Task> tasks;

    public ListAdapterTaskTomorrowDone(Context context, List<Task> tasks){
        this.tasks = tasks;
