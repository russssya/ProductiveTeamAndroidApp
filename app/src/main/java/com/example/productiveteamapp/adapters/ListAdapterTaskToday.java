...
public class ListAdapterTaskToday extends RecyclerView.Adapter<ListAdapterTaskToday.ViewHolder>{

    final LayoutInflater inflater;
    final List<Task> tasks;
    static ItemClickListener clickListener;

    public ListAdapterTaskToday(Context context, List<Task> tasks){
        this.tasks = tasks;
