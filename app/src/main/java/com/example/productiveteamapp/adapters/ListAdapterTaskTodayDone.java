...
public class ListAdapterTaskTodayDone extends RecyclerView.Adapter<ListAdapterTaskTodayDone.ViewHolder> {

    final LayoutInflater inflater;
    final List<Task> tasks;

    public ListAdapterTaskTodayDone(Context context, List<Task> tasks){
        this.tasks = tasks;
